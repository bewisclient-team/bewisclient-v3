...
object SpeedWidget: LineWidget(), EventEntrypoint {
    val verticalSpeed = BooleanSetting(false)

    init {
        create("vertical_speed", verticalSpeed)
    }

    val speedWidgetTranslation = Translation("widget.speed_widget.name", "Speed Widget")
    val speedWidgetDescription = Translation("widget.speed_widget.description", "Displays your current speed in blocks per second.")
    ...
    override fun appendSettingsRenderables(list: ArrayList<net.bewis09.bewisclient.drawable.Renderable>) {
        list.add(verticalSpeed.createRenderable("widget.speed_widget.vertical_speed", "Include Vertical Speed"))
