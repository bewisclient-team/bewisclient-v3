...
object SpeedWidget : LineWidget(), EventEntrypoint {
    ...
    val speedWidgetDescription =
        Translation(
            "widget.speed_widget.description",
    ...
    override fun getOutOfWorldLines(): List<String> =
        listOf(if (verticalSpeed.get()) "6.90 m/s" else "4.20 m/s")

    override fun defaultPosition(): WidgetPosition =
        RelativePosition("bewisclient:ping_widget", "bottom")
    ...
    override fun appendSettingsRenderables(
        ...
        list.add(
            verticalSpeed.createRenderable(
                "widget.speed_widget.vertical_speed",
