...
object BetterVisibility : ImageSettingCategory(
    "better_visibility", Translation("menu.category.better_visibility", "Better Visibility"), arrayOf(
        BetterVisibilitySettings.nether.createRenderable("better_visibility.nether", "Nether", "Improve visibility in the Nether dimension"), BetterVisibilitySettings.water.createRenderable("better_visibility.water", "Water", "Enhance visibility underwater"), BetterVisibilitySettings.lava.createRenderable("better_visibility.lava", "Lava", "Boost visibility in lava"), BetterVisibilitySettings.powder_snow.createRenderable("better_visibility.powder_snow", "Powder Snow", "Increase visibility in powder snow")
    ...
    val fogModifiers =
        listOf(
            FogModifierConfig(BetterVisibilitySettings.nether, DimensionOrBossFogModifier::class.java, { it * 2 - MathHelper.clamp(it / 10.0f, 4.0f, 64.0f) }, { it * 2 }), FogModifierConfig(BetterVisibilitySettings.water, WaterFogModifier::class.java, { -8f }, { it }), FogModifierConfig(BetterVisibilitySettings.lava, LavaFogModifier::class.java, { -8f }, { 16f }), FogModifierConfig(BetterVisibilitySettings.powder_snow, PowderSnowFogModifier::class.java, { -8f }, { 8f })
        )
