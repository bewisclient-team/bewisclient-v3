...
class ResetButton<T>(val setting: Settable<T?>) : TooltipHoverable(Translations.RESET()) {
    ...
    override fun render(screenDrawing: ScreenDrawing, mouseX: Int, mouseY: Int) {
        ...
        screenDrawing.drawTexture(createIdentifier("bewisclient", "textures/gui/sprites/reset.png"), x + 2, y + 2, width - 4, height - 4, OptionsMenuSettings.themeColor.get().getColor())
    }
