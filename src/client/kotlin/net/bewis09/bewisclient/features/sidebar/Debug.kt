...
object Debug: SidebarFeature(createIdentifier("bewisclient", "debug"), "Debug") {
    ...
    val highlightBorderColor = color("border_color", Color.YELLOW)
    val highlightBorderAlpha = float("border_alpha", 0.2f, 0f, 1f, 0.01f, 2)
    ...
    override fun getRenderable(): Renderable = DivElement {
        ...
        onInit = {
            ...
            highlightBorderColor.createRenderableWithFader(this@Debug, "border_color", "Border Color", null, highlightBorderAlpha).add()
