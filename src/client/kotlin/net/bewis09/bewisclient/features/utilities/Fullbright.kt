...
object Fullbright : ImageFeature(createIdentifier("bewisclient", "fullbright"), "Fullbright") {
    ...
    val brightnessTranslation = createTranslation("change_brightness", "Brightness: %s")
    ...
    object ToggleNightVision : Keybind(InputConstants.KEY_H, "fullbright.toggle_night_vision", "Toggle Night Vision", {
    ...
    object ToggleFullbright : Keybind(InputConstants.KEY_G, "fullbright.toggle_fullbright", "Toggle Fullbright", {
    ...
    object IncreaseBrightness : Keybind(InputConstants.KEY_UP, "fullbright.increase_brightness", "Increase Brightness", {
        brightness = 15f.coerceAtMost(brightness + 0.25f)
        showFullbrightMessage()
    })

    object DecreaseBrightness : Keybind(InputConstants.KEY_DOWN, "fullbright.decrease_brightness", "Decrease Brightness", {
